...
CREATE TABLE `t_testing_case`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '测试用例' ROW_FORMAT = Dynamic;
...
CREATE TABLE `t_testing_plan`  (
  ...
  `create_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '测试计划管理' ROW_FORMAT = Dynamic;
...
INSERT INTO `t_user` VALUES (2, NULL, 3, '新用户', '123', 'admin2', '123', 1, 1, '2023-03-16 18:56:06', '21232f297a57a5a743894a0e4a801fc3');
INSERT INTO `t_user` VALUES (3, NULL, 4, '测试', '222', '111', '222', 1, 1, '2023-03-16 19:06:43', '698d51a19d8a121ce581499d7b701668');
INSERT INTO `t_user` VALUES (4, '1637707889027543040', 2, '新用户', '123456561', '123445234', '123124', 1, 1, '2023-03-20 14:49:22', '5f4dcc3b5aa765d61d8327deb882cf99');
INSERT INTO `t_user` VALUES (5, '1637709882768977920', 2, '新用户', '1234565621', '1234452342', '1232124', 1, 1, '2023-03-20 14:57:17', '5f4dcc3b5aa765d61d8327deb882cf99');
